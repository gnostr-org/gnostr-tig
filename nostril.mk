...
nostril-dist: docs version## 	dist
	@mkdir -p dist
...
.PHONY:nostril
nostril: libsecp256k1.a $(HEADERS) $(OBJS)## 	nostril
	@$(CC) $(CFLAGS) $(OBJS) $(ARS) -o $@ || $(MAKE) $(ARS)
	cp nostril gnostr

nostril-install: all## 	install
...
nostril-config.h: configurator## 	config.h
	./configurator > $@
