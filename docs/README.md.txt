...
&ndash;content The text contents of the note

&ndash;dm Create a direct message. This will create a kind-4 note with
the contents encrypted>

&ndash;envelope Wrap the event with ["EVENT", ... ] for easy relaying

&ndash;kind Set the kind of the note

&ndash;created-at Set the created at. Optional, this is set
automatically.

&ndash;mine-pubkey Mine a pubkey. This may or may not be
cryptographically dubious.

&ndash;pow Number of leading 0 bits of the id the mine for
proof-of-work.

&ndash;tag Add a tag with a single value

-t Shorthand for &ndash;tag t

-p Shorthand for &ndash;tag p

-e Shorthand for &ndash;tag e
Examples
