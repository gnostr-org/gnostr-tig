...
install: all
	...
	$(QUIET_INSTALL)tools/install.sh bin nostril "$(DESTDIR)$(bindir)"
	$(QUIET_INSTALL)tools/install.sh bin nostril-tig "$(DESTDIR)$(bindir)"
	$(QUIET_INSTALL)tools/install.sh bin gnostr-tig "$(DESTDIR)$(bindir)"
